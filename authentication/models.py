...
class RetailerInfo(models.Model):
    ...
    second_contact_first_name = models.CharField(max_length=50, null=True)
    second_contact_last_name = models.CharField(max_length=50, null=True)
    second_contact_phone_number = models.CharField(max_length=25, null=True)
